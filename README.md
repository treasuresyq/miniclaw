...
Miniclaw 采用智能体优先工作模型，并坚持本地优先和显式集成：数据库、工作区元数据、会话状态和配置由自己的服务管理；模型、消息渠道、Docker 与外部工具都作为可配置边界接入。
...
<p align="center">
  ...
  <img src="docs/screenshots/cron-task.png" alt="Miniclaw 定时任务" width="49%" />
  <img src="docs/screenshots/custom-agent.png" alt="Miniclaw 自定义Agent" width="49%" />
</p>
